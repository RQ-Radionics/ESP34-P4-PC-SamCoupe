...
// ESP32-P4: reduced from 6 (64x) to 2 (4x) for performance.
// 64x oversample at 22050Hz = 1.4M chip ticks/frame — too slow.
// 4x oversample at 22050Hz = 88K chip ticks/frame — manageable.
#define DEFAULT_OVERSAMPLE 2
...
// Disabled for ESP32 build (no filesystem config file support needed)
