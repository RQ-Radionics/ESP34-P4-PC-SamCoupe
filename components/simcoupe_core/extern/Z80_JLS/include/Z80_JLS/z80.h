...
public:
    ...
    // Expose prefix state for loop control (0 = no prefix active)
    static uint8_t getPrefixOpcode() { return prefixOpcode; }
...
private:
    ...
    // check_trdos removed (ESPectrum-specific TR-DOS paging)
};
